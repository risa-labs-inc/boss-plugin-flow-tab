...
A lanager sub-run's lifetime is bound to its node: stopping or timing out the parent explicitly
stops the sub-run, and nested lanagers cascade that stop through their own children.
