...
/**
 * Base card height for the type/status eyebrow, a two-line readable title, and action
 * summary. The generous world-space budget keeps this content visible on HiDPI displays.
 */
const val NODE_ROW_H = 160f
